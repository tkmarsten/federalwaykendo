export default function Curriculum() {
  return (
    <main>
      ...
      <p>
        *Classes are always subject to change based on the overall skill level,
        age range, and progression of the students. We adjust the speed and
        curriculum week by week to best fit the class.
      </p>
    </main>
  );
}
